...
void xgeqp3(emxArray_real_T *A, emxArray_real_T *tau, emxArray_int32_T *jpvt)
{
  ...
  i52 = tau->size[0];
  tau->size[0] = mn;
  emxEnsureCapacity((emxArray__common *)tau, i52, (int)sizeof(double));
  ...
  if ((A->size[0] == 0) || (A->size[1] == 0)) {
    ...
    i52 = work->size[0];
    work->size[0] = itemp;
    emxEnsureCapacity((emxArray__common *)work, i52, (int)sizeof(double));
    for (i52 = 0; i52 < itemp; i52++) {
      work->data[i52] = 0.0;
    }
    ...
    i52 = vn1->size[0];
    vn1->size[0] = itemp;
    emxEnsureCapacity((emxArray__common *)vn1, i52, (int)sizeof(double));
    i52 = vn2->size[0];
    vn2->size[0] = vn1->size[0];
    emxEnsureCapacity((emxArray__common *)vn2, i52, (int)sizeof(double));
    k = 1;
